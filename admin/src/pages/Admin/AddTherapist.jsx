...
const AddTherapist = () => {
    ...
    const [speciality, setSpeciality] = useState('General Therapy')
...
<div className='flex flex-col lg:flex-row items-start gap-10 text-gray-600'>
    ...
    <div className='w-full lg:flex-1 flex flex-col gap-4'>
        ...
        <div className='flex-1 flex flex-col gap-1'>
            <p>Experience</p>
            <select onChange={e => ssetExperience(Number(e.target.value))} value={experience} className='border rounded px-2 py-2' >
    ...
    <div className='w-full lg:flex-1 flex flex-col gap-4'>
        ...
        <div className='flex-1 flex flex-col gap-1'>
                            ...
                            <select onChange={e => setSpeciality(e.target.value)} value={speciality} className='border rounded px-2 py-2'>
                                ...
                                <option value="Child & Adolosence Psychologist">Child & Adolosence Psychologist</option>
                                <option value="Marriage Counseling">Marriage Counseling</option>
                                <option value="Trauma Psychologist">Trauma Psychologist</option>
                                <option value="Drug & Addiction Psychologist">Drug & Addiction Psychologist</option>
                                <option value="Behavioural Psychologist">Behavioural Psychologist</option>
                            </select>
                        </div>
