                ...
                <table className="w-full border-collapse mt-4">
                    <thead>
                        <tr className="bg-gray-100">
                            ...
                            <th className="border p-2">Therapy Session</th>
                            <th className="border p-2">Remove Record</th>
                        </tr>
                    </thead>
                    <tbody>
                        {filteredData.slice(0, 5).map((item, index) => (
                            <tr key={index} className="hover:bg-gray-50">
                                <td className="border p-2 flex items-center gap-3">
                                    <img className='rounded-full w-10' src={item.userImage || assets.default_user} alt="User" />
                                    <span>{item.name}</span>
                                </td>
                                <td className="border p-2">{currency} {item.amount}</td>
