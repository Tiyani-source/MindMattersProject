...
// No antd imports - using native React components instead

const CartPaymentDashboard = () => {
  ...
  // Table state
  const [paymentData] = useState(initialPaymentData);
  ...
  // Download PDF report (simplified simulation)
  const downloadPDF = () => {
    alert('PDF download started. In a real implementation, this would generate a PDF with the current filtered data.');
  };
    ...
    <div className="p-6 max-w-6xl mx-auto">
      <div className="bg-white rounded-lg shadow-md p-6">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-6">
          <h3 className="text-xl font-bold">Cart Payment Dashboard</h3>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
          ...
          {/* Table Container - Takes up 2/3 of the width on large screens */}
...
export default CartPaymentDashboard;