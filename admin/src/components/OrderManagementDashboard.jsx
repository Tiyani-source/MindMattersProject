    ...
    <div className="mt-4 space-y-4">
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
        <OrderStatusCard
          ...
          icon={<FaChartLine className="text-red-500 text-l" />}
        ...
        <OrderStatusCard
          ...
          icon={<FaSearch className="text-blue-500 text-l" />}
          onClick={() => handleCardClick('overview')}
          isActive={activeCard === 'overview'}
        />
        <OrderStatusCard
          title="Status Control & Actions"
          count={orders.length}
          description="Update order statuses and manage processing"
          bgColor="bg-gradient-to-br from-green-50 to-green-100"
          icon={<FaTasks className="text-green-500 text-l" />}
        ...
        <OrderStatusCard
          ...
          icon={<FaTruck className="text-purple-500 text-l" />}
