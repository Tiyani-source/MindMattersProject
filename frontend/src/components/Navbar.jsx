...
const Navbar = () => {
  ...
  return (
    <div className="flex items-center justify-between md:justify-end text-sm py-4 mb-5 border-b border-b-gray-400">
      ...
      {/* Mobile Menu */}
      <div className={`md:hidden fixed top-0 right-0 bottom-0 bg-white overflow-hidden z-30 transition-all duration-300 ${showMenu ? 'w-3/4' : 'w-0'}`}>
        ...
        <ul className="flex flex-col gap-2 mt-5 px-5 text-lg font-medium">
          ...
          <NavLink onClick={() => setShowMenu(false)} to="/store"><p className="px-4 py-2">ONLINE STORE</p></NavLink>
